          ...
          <div class="w-full relative">
            ...
            <Transition name="slide">
              <ul
                ...
                class="transition-all max-h-[150px] duration-400 ease-in-out absolute bg-gray-600 rounded-lg shadow-lg w-full z-10 mt-1 divide-y overflow-x-hidden overflow-y-auto flex flex-col justify-evenly items-center"
